      ...
      <CardContent sx={{ px: { xs: 2, sm: 3 }, py: 2 }}>
        ...
        <Stack spacing={2}>
          ...
          >
            ...
            <Typography variant="body1">
              <strong>Address:</strong> {details.patient?.address || "N/A"}
            </Typography>
          </Box>
        </Stack>
      </CardContent>
    ...
    <Card elevation={3} sx={{ width: "100%", height: "100%" }}>
      <CardContent sx={{ px: { xs: 2, sm: 3 }, py: 2 }}>
        ...
        <Stack spacing={2}>
          ...
          <Box>
            <Typography variant="body1">
              <strong>Symptoms:</strong> {details.patient?.symptoms || "N/A"}
            </Typography>
          </Box>
        ...
        >
          <CardContent sx={{ px: { xs: 1, sm: 2, md: 3 }, py: { xs: 2, sm: 3 } }}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6} md={3}>
                <Box>
                  ...
                  <Typography variant="body1">
                    {details.startDate ? formatDate(details.startDate) : 'N/A'}
                  </Typography>
                </Box>
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <Box>
                  ...
                  <Typography variant="body1">
                    {details.nextVisit ? formatDate(details.nextVisit) : 'N/A'}
                  </Typography>
                </Box>
              </Grid>
            ...
            <Box>
              ...
              <Typography variant="body1">
                Patient has taken <strong>{details.medicineTakenPatient || '0'}</strong> dose(s)
              </Typography>
            </Box>
          </CardContent>
        </Card>
