...
//             // Determine if field is textarea
//             const isTextarea = key === "address" || key === "symptoms";
...
//                       .replace(/([A-Z])/g, " $1")
//                       .toLowerCase()}...`}
//                     className="border border-gray-300 rounded-lg px-4 py-3 text-gray-700 resize-y focus:outline-none focus:ring-4 focus:ring-indigo-300 transition-shadow duration-300 hover:shadow-lg"
//                   />
//                 ) : (
//                   <input
//                     id={key}
...
//             <button
//               type="submit"
//               className="bg-indigo-600 text-white text-lg font-bold px-10 py-3 rounded-xl shadow-lg hover:bg-indigo-700 transition-transform transform hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-indigo-400"
//             >
//               Add Patient
//             </button>
//           </div>
